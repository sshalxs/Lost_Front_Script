...
local function ShowAimbotSettings()
    ...
    redBtn.Parent = frame
    redBtn.MouseButton1Click:Connect(function() settings.aimbotTargetTeam = "Red" DynamicIsland("🎯 Цель: Красные", "function") end)
    ...
    blueBtn.MouseButton1Click:Connect(function() settings.aimbotTargetTeam = "Blue" DynamicIsland("🎯 Цель: Синие", "function") end)
    ...
    allBtn.Parent = frame
    allBtn.MouseButton1Click:Connect(function() settings.aimbotTargetTeam = "All" DynamicIsland("🎯 Цель: Все", "function") end)
    ...
    headBtn.MouseButton1Click:Connect(function() settings.aimbotTargetPart = "Head" DynamicIsland("🎯 Часть: Голова", "function") end)
    ...
    torsoBtn.MouseButton1Click:Connect(function() settings.aimbotTargetPart = "Torso" DynamicIsland("🎯 Часть: Торс", "function") end)
...
local function CreateMenu()
    ...
    AddButton("AIMBOT", function() settings.AimbotEnabled = not settings.AimbotEnabled DynamicIsland("🔧 ВЫ " .. (settings.AimbotEnabled and "ВКЛЮЧИЛИ" or "ВЫКЛЮЧИЛИ") .. " ФУНКЦИЮ AIMBOT", "function") end, "Автонаведение на цель", true)
